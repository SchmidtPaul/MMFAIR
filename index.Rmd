...
Find examples by navigating the menu at the top of the page. Each example focuses on a certain aspect of mixed modelling. Within each example, switch between tabs with codes from the different packages via these buttons:
